...
from pydantic import BaseModel, Field, conlist, conint, model_validator
...
class ContestDraw(BaseModel):
    ...
    numbers: conlist(conint(ge=1, le=60), min_length=6, max_length=6) = Field(
    ...
    def _validate_unique_numbers(self):
